    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text-main)] font-sans">
      <section className="bg-slate-900 text-white py-20 px-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 tracking-tight">{acf.heroTitle || 'Bao Bi Cho Nganh TPCN & Duoc Pham'}</h1>
          <p className="text-xl text-slate-300 max-w-2xl">{acf.heroSubtitle || 'Hop cung ep kim vang, chuan Pantone — Nang tam gia tri san pham TPCN'}</p>
        </div>
      </section>
      <section className="py-24 px-8 bg-[var(--bg)] text-center">
        <div className="max-w-3xl mx-auto">
          ...
          {acf.introContent ? (
            ...
            <p className="text-[var(--text-dim)] text-lg leading-relaxed">Nganh TPCN & Duoc pham yeu cau bao bi vua cao cap vua chuyen nghiep.</p>
          )}
        </div>
      </section>
      ...
      <section className="py-24 px-8 bg-[var(--bg)]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-[var(--accent)] font-bold text-lg">{acf.pricingText || 'Gia tu 10.200d/hop (MOQ 500). Don tu 5.000 hop giam them 10-15%.'}</p>
        </div>
      </section>
      <section className="py-24 px-8 bg-[var(--card-bg)] border-y border-[var(--border)]">
        <div className="max-w-6xl mx-auto">

...
// Ánh xạ chuỗi tên icon sang component Lucide tương ứng
...
const defaultIndustries = [
  {
    ...
    description: 'Hộp giấy, hộp cứng cao cấp bảo vệ sản phẩm, tăng độ tin cậy cho thương hiệu.',
    icon: 'Package',
  ...
  },
  {
    ...
    description: 'Bao bì sang trọng, ép kim, cán mờ tôn lên vẻ đẹp của sản phẩm làm đẹp.',
    icon: 'Sparkles',
  ...
  {
    title: 'Yến sào',
    description: 'Hộp cứng lót nhung, thiết kế truyền thống kết hợp hiện đại, xứng tầm sản vật quý.',
    icon: 'Heart',
  ...
  },
  {
    ...
    description: 'Hộp cứng nhỏ gọn, tinh xảo, đóng mở nam châm tạo trải nghiệm unboxing đẳng cấp.',
    icon: 'Gift',
  ...
  {
    title: 'Ecommerce',
    description: 'Hộp sóng in logo, chắc chắn, bảo vệ hàng hóa trong vận chuyển với chi phí tối ưu.',
    icon: 'ShoppingCart',

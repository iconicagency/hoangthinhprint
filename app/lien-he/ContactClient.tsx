    ...
    <div className="min-h-screen bg-white text-[var(--text-main)] font-sans">
      <section className="relative py-24 px-8 bg-[var(--bg)] text-[var(--text-main)] overflow-hidden border-b border-[var(--border)]">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-[var(--text-dim)] text-lg max-w-2xl">Đội ngũ tư vấn sẵn sàng hỗ trợ bạn trong 30 phút.</p>
        </div>
      </section>
          ...
          <div className="space-y-8 mb-12">
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <a href={`tel:${settings.contactPhone.replace(/\D/g, '')}`} className="font-bold text-[var(--text-main)] text-lg hover:text-[var(--accent)] transition-colors">{settings.contactPhone}</a>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <a href={`mailto:${settings.contactEmail}`} className="font-bold text-[var(--text-main)] hover:text-[var(--accent)] transition-colors">{settings.contactEmail}</a>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              <div className="w-12 h-12 bg-[var(--accent)]/10 rounded-full flex items-center justify-center text-[var(--accent)] shrink-0"><Building2 size={24} /></div>
              <div>
                <div className="text-sm text-[var(--text-dim)] font-bold uppercase tracking-wider mb-1">VĂN PHÒNG & XƯỞNG</div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-1">
                  <a href={settings.facebookLink} target="_blank" rel="noopener noreferrer" className="px-5 py-2 border border-[var(--border)] rounded-lg text-[var(--text-main)] font-medium hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors bg-[var(--card-bg)] shadow-sm text-sm">Facebook</a>
                  <a href={settings.zaloLink} target="_blank" rel="noopener noreferrer" className="px-5 py-2 border border-[var(--border)] rounded-lg text-[var(--text-main)] font-medium hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors bg-[var(--card-bg)] shadow-sm text-sm">Zalo</a>
                </div>
              </div>
            </div>
          </div>
